...
interface ExecutionDetail {
  ...
  error: string;
  input: Record<string, unknown>;
  outputs: Record<string, { type: string; value: unknown; source_node_id: string; title?: string; description?: string; filename?: string; mime_type?: string; downloadable?: boolean }>;
