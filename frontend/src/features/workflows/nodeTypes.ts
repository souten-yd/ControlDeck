...
export const NODE_TYPES: Record<string, NodeTypeDef> = {
  ...
  "academic.search": {
    ...
    color: "#a855f7",
    icon: "🎓",
    desc: "論文・文献を検索（arXiv / Crossref）。結果は RAG 取り込みや要約に渡せる",
    fields: [
      { key: "source", label: "ソース", type: "select", options: [{ value: "arxiv", label: "arXiv（論文）" }, { value: "crossref", label: "Crossref（文献/DOI）" }] },
